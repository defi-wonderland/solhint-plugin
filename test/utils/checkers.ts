...
function coreRules(meta) {
  ...
  const wonderlandPluginRules = [new NamedReturnValuesChecker(reporter), new NonStateVarsLeadingUnderscoreChecker(reporter), new InterfaceStartsWithIChecker(reporter)];
