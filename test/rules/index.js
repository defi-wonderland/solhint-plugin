...
const security = require('solhint/lib/rules/security/index')
const naming = require('solhint/lib/rules/naming/index')
const order = require('solhint/lib/rules/order/index')
const bestPractises = require('solhint/lib/rules/best-practises/index')
const deprecations = require('solhint/lib/rules/deprecations/index')
const miscellaneous = require('solhint/lib/rules/miscellaneous/index')
const configObject = require('solhint/lib/config')
const { validSeverityMap } = require('solhint/lib/config/config-validator')
const NamedReturnValuesChecker = require('../../rules/named-return-values')
